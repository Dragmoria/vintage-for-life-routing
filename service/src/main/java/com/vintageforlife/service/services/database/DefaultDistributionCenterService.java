...
@Service
public class DefaultDistributionCenterService implements DistributionCenterService {
    ...
    @Autowired
    public DefaultDistributionCenterService(DistributionCenterRepository distributionCenterRepository, DistributionCenterMapper distributionCenterMapper, AddressMapper addressMapper) {
